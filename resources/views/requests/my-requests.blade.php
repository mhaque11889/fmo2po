...
<div class="mb-6">
    ...
    @if($isGroupView)
        <p class="mt-2 text-sm text-indigo-600">Showing requests from you and your group members.</p>
    @endif
...
<div class="bg-white rounded-lg shadow overflow-hidden">
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    @if($isGroupView)
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            ...
                            @else
                                <span class="text-gray-900">{{ $request->creator->name }}</span>
            ...
            @empty
                <tr>
                    <td colspan="{{ $isGroupView ? 8 : 7 }}" class="px-6 py-4 text-center text-gray-500">
                        No requests found
                    </td>
                </tr>
            @endforelse
